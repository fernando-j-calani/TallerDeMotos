...
from taller.views import (
    ...
    inventario_api,
    inventario_ajuste_api,
    inventario_historial_api,
    compras_api,
    cotizaciones_api,
...
urlpatterns = [
    ...
    path('api/refresh-token/', refresh_token_api, name='api_refresh_token'),
    # Ruta para el CU20
    ...
    path('api/inventario/ajuste/', inventario_ajuste_api, name='api_inventario_ajuste'),
    path('api/inventario/historial/', inventario_historial_api, name='api_inventario_historial'),
    ...
    path('api/facturacion/<int:factura_id>/', factura_detalle_api, name='api_factura_detalle'),
    ...
    path('api/mis-facturas/', mis_facturas_api, name='api_mis_facturas'),
