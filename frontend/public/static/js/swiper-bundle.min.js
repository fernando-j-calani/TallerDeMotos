...
var Swiper = function() {
        ...
        for (let s = 1; s < e.length; s += 1) {
            ...
            if (null != a && !p(a)) {
                ...
                for (let s = 0, i = e.length; s < i; s += 1) {
                    ...
                    void 0 !== r && r.enumerable && (c(t[i]) && c(a[i]) ? a[i].__swiper__ ? t[i] = a[i] : u(t[i], a[i]) : !c(t[i]) && c(a[i]) ? (t[i] = {},
                    a[i].__swiper__ ? t[i] = a[i] : u(t[i], a[i])) : t[i] = a[i])
                }
            }
        }
        return t
    ...
    var H = {
        ...
        updateSlides: function() {
            ...
            s.cssMode && (m(a, "--swiper-slides-offset-before", `${f}px`),
            ...
            !s.centeredSlides) {
                ...
                if (a) {
                    ...
                    if ("auto" === s.slidesPerView) {
                        e = 1;
                        let t = 0;
                        for (let s = h.length - 1; s >= 0 && (t += h[s] + (s < h.length - 1 ? x : 0),
                        t <= E); s -= 1)
                            e = h.length - s
                    } else
    ...
    , function({swiper: e, extendParams: t, on: s, emit: i}) {
        ...
        function o(t) {
            ...
            if (a.shiftKey || a.altKey || a.ctrlKey || a.metaKey)
                return;
            if (n.activeElement && (n.activeElement.isContentEditable || n.activeElement.nodeName && ("input" === n.activeElement.nodeName.toLowerCase() || "textarea" === n.activeElement.nodeName.toLowerCase())))
                return;
            ...
            ((d || p) && !s || (c || u) && s) && e.slidePrev(f)) : ((d || c || m || h) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1),
            (c || h) && e.slideNext(f),
            (d || m) && e.slidePrev(f)),
            i("keyPress", r)
        }
    ...
    , function({swiper: e, extendParams: t, on: s, emit: a}) {
        ...
        function O() {
            ...
            h.imageEl && h.imageWrapEl && (h.maxRatio = S(),
    ...
    , function({swiper: e, extendParams: t, on: s, emit: i, params: r}) {
        ...
        let o, d, c, p, u, m, h, f = r && r.autoplay ? r.autoplay.delay : 3e3, g = r && r.autoplay ? r.autoplay.delay : 3e3, v = (new Date).getTime();
        function w(t) {
    ...
    , function({swiper: e, extendParams: t, on: s}) {
        ...
        function o() {
            ...
            n() && e.thumbs.swiper.on("virtualUpdate", () => {
                d(!1, {
                    autoScroll: !1
                })
            }
        ...
        function d(t, s) {
            ...
            (s?.autoScroll ?? 1) && function(t) {
                ...
                if (e.realIndex !== s.realIndex || r) {
                    ...
                    r && (l += "next" === o ? i : -1 * i),
                    s.visibleSlidesIndexes && s.visibleSlidesIndexes.indexOf(l) < 0 && (s.params.centeredSlides ? l = l > n ? l - Math.floor(a / 2) + 1 : l + Math.floor(a / 2) - 1 : l > n && s.params.slidesPerGroup,
                    s.slideTo(l, t))
                }
            }(t ? 0 : void 0)
        }
